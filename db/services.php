...
$functions = array(
    ...
    'format_mytopcoll_get_edit_indicator' => array(
        ...
        'classpath' => 'course/format/mytopcoll/externallib.php',
        'description' => 'Get all data for the current indicator',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'format/mytopcoll:editcourseformat',
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ...
    'format_mytopcoll_set_edit_indicator' => array(
        ...
        'classpath' => 'course/format/mytopcoll/externallib.php',
        'description' => 'Edit current activity indicator or add new indicator',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'format/mytopcoll:editcourseformat',
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'format_mytopcoll_update_indicator_name' => array(
        'classname' => 'format_mytopcoll_external',
        'methodname' => 'update_indicator_name',
        'classpath' => 'course/format/mytopcoll/externallib.php',
        'description' => 'Update indicators name',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'format/mytopcoll:editcourseformat',
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
